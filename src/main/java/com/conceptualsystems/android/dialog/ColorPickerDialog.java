package com.conceptualsystems.android.dialog;
...
public class ColorPickerDialog extends Dialog implements SeekBar.OnSeekBarChangeListener, TextWatcher, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		redText.setText(r.toString());
		greenText.setText(g.toString());
		blueText.setText(b.toString());
		alphaText.setText(a.toString());
